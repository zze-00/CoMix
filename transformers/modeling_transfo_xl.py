    ...
    if hasattr(model, 'transformer'):
        ...
        for i, (out_l, proj_l, tie_proj) in enumerate(zip(
            ...
            if config.tie_weight:
                ...
                # I don't think this is implemented in the TF my_code
                tf_to_pt_map.update({
...
class TransfoXLModel(TransfoXLPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        if config.attn_type == 0: # the default attention
            ...
            raise NotImplementedError  # Removed them to avoid maintaining dead my_code
        ...
        if self.attn_type == 0: # default attention
            ...
            raise NotImplementedError  # Removed these to avoid maintaining dead my_code - They are not used in our pretrained checkpoint
    ...
    def forward(self, input_ids, mems=None, head_mask=None):
        # the original my_code for Transformer-XL used shapes [len, bsz] but we want a unified interface in the library
